...
HD_PWD='C:/Users/beful/ee214_proj1_req3/ee214_proj1_req3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log all_led_sw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source all_led_sw.tcl
