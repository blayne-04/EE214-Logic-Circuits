...
HD_PWD='C:/Users/beful/ee214_proj1_req3/ee214_proj1_req3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log all_led_sw.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source all_led_sw.tcl -notrace
