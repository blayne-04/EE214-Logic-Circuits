...
HD_PWD='C:/Users/beful/Downloads/WSU_2025/EE214 Logic Circuits/Proj1/ee214_proj1_req4/ee214_proj1_req4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log all_led_reverse.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source all_led_reverse.tcl
